...
@section('content')
    ...
    <form action="/admin/proizvodi/{{ $proizvod->id }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('naziv') is-invalid @enderror" id="naziv" name="naziv"
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('grupa') is-invalid @enderror" id="grupa" name="grupa"
                value="{{ old('grupa', $proizvod->grupa) }}" required>
            @error('grupa')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
